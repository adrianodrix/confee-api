    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            if (! $token = app('tymon.jwt.auth')->attempt($credentials)) {
                ...
                return response()->json(['error' => Lang::get('auth.failed')], Response::HTTP_UNAUTHORIZED);
            }
            ...
            return response()->json(['error' => Lang::get('auth.could_not_create_token')], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
